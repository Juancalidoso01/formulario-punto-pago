...
export const esMessages = {
  ...
  wizard: {
    ...
    steps: {
      ...
      business: {
        ...
        desc: "Favor describe con mayor detalle lo que hace tu negocio o empresa.",
      },
      occupation: {
        title: "¿Cuál es su profesión u ocupación principal?",
        desc: "Escriba para buscar en el catálogo o abra el listado y elija la opción que mejor describe su rol.",
      },
      activity: {
        title: "¿Qué actividad económica describe mejor su negocio?",
        desc: "Escriba para buscar en el catálogo o abra el listado y elija la actividad principal de su empresa.",
      },
      cuotasPlan: {
    ...
    fields: {
      ...
      occupationPh: "Ej: comerciante, abogado, administrador…",
      activity: "Actividad económica",
      activityPh: "Ej: comercio al por menor, restaurante, servicios…",
    },
    errors: {
      ...
      business: "Describa brevemente su negocio.",
      occupation: "Busque y seleccione su profesión u ocupación del listado.",
      activity: "Busque y seleccione la actividad económica de su negocio del listado.",
  ...
  common: {
    ...
    kybCatalogNote:
      "El catálogo de profesiones y actividades se muestra en español (fuente oficial KYB).",
  },
};
