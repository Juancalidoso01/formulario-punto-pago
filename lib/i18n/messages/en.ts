...
export const enMessages: Messages = {
  ...
  wizard: {
    ...
    steps: {
      ...
      business: {
        title: "What type of business do you run and what do you offer?",
        desc: "First pick from the list the type that best matches yours (grocery, restaurant, pharmacy, etc.). Then describe in your own words what you sell or offer.",
      },
      occupation: {
        title: "Owner's profession or occupation",
        desc: "The person registering or representing the business. Pick their personal job or trade—not the type of store.",
      },
      activity: {
        title: "Business activity",
        desc: "Only for some product lines. Pick your company's activity from the list. For kiosks and agent, the business type step above is enough.",
      },
      cuotasPlan: {
      ...
      aviso: {
        title: "Copy of business operation notice",
        desc: "Upload the document issued by the authority. PDF or a photo of the paper (JPG, PNG).",
        dropzone: "Tap here or drag your file",
        dropzoneActive: "Drop file here",
        browse: "Choose PDF or photo",
        remove: "Remove file",
        formatHint: "PDF or image · max 15 MB",
      },
      clients: {
    ...
    fields: {
      ...
      description: "What do you sell or offer?",
      descriptionPh: "E.g. groceries, bread, top-ups, open 8am–6pm…",
      mcc: "Type of business",
      mccPh: "Tap to open the list or type to search",
      occupation: "Owner's profession",
      occupationPh: "E.g. merchant, shop owner, employee…",
      activity: "Business activity",
      activityPh: "Tap to open the list or type to search",
    },
    errors: {
      ...
      mcc: "Select your business type from the list.",
      occupation: "Select the owner's profession or occupation.",
      activity: "Select the business activity from the list.",
      ...
      aviso: "Attach the operation notice (PDF or photo).",
      avisoFormat: "The notice must be a PDF or image (JPG, PNG, etc.).",
  ...
  common: {
    ...
    kybCatalogNote:
      "The lists in this form are shown in Spanish.",
  },
};
